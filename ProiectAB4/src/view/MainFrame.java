...
public class MainFrame extends javax.swing.JFrame {
    ...
    public MainFrame() {
        initComponents();
        jButton1.addActionListener(ev->adaugaLocatie());
        jButton2.addActionListener(ev->veziLocatie(listaLocatii));
    ...
    public void adaugaLocatie( ){
        ...
        Locatie locatie = new Locatie.Builder()
                .setNume(nume)                                  //Am creat o instanta de Locatie pe baza inputurilor
                .setOras(oras)
    ...
    public void veziLocatie(List<Locatie> lista){
    ...
    public void getTopLocatii(){
        ...
        System.out.println(listaTopLocatii.isEmpty());
        if(!listaTopLocatii.isEmpty()){
            //Se afiseaza top 5 locatii
          for(int i = 0;i<listaTopLocatii.size()-1;i++){
            if(i<5)
